...
class OrochiUtils
{
  public:
	...
	static oroFunction getFunctionFromFile( oroDevice device, const char* path, const char* funcName, const std::vector<const char*>& opts );
	static oroFunction getFunction( oroDevice device, const char* code, const char* path, const char* funcName, const std::vector<const char*>& opts );
